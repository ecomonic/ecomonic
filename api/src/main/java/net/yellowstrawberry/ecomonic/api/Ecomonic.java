...
public interface Ecomonic {
    ...
    Ecomonic INSTANCE = Bukkit.getPluginManager().getPlugin("Ecomonic") instanceof Ecomonic ecomonic ? ecomonic : null;
    ...
    /**
     * Sets the primary account for the specified UUID.
     *
     * @param uuid the UUID of the player
     * @param account the account to set as primary
     */
    void setPrimaryAccount(UUID uuid, Account account);
